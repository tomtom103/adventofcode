...
- To find oxygen generator rating, determine the most common value (0 or 1) in the current bit position, and keep only numbers with that bit in that position. If 0 and are equally common, keep values with a 1 in the position being considered.
...
__What is the life support rating of the submarine?__ (Be sure to represent your answer in decimal, not binary.)